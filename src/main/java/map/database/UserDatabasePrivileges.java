...
public final class UserDatabasePrivileges {
    ...
    static Map<String, String> runtimeChecks() {
        ...
        checks.put("history_read_only", "SELECT has_table_privilege('user_service.flyway_schema_history','SELECT') AND NOT (has_table_privilege('user_service.flyway_schema_history','INSERT') OR has_table_privilege('user_service.flyway_schema_history','UPDATE') OR has_table_privilege('user_service.flyway_schema_history','DELETE') OR has_any_column_privilege('user_service.flyway_schema_history','INSERT') OR has_any_column_privilege('user_service.flyway_schema_history','UPDATE'))");
