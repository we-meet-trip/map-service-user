...
/**
 * BikeStationException — hub 따릉이 대여소 조회 실패 표현 예외
 *
 * BikeStationClient 가 hub 로부터 4xx/5xx 응답을 받았을 때 던지는
 ...
 */
public class BikeStationException extends RuntimeException {

    private final int statusCode;
    private final String body;

    public BikeStationException(int statusCode, String body) {
        super("bike stations " + statusCode + ": " + truncate(body, 200));
