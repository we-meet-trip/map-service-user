...
/**
 * PlaceSearchException — hub 장소 조회 실패 표현 예외
 *
 * PlaceSearchClient 가 hub 로부터 4xx/5xx 응답을 받았을 때 던지는
...
public class PlaceSearchException extends RuntimeException {
    ...
    public PlaceSearchException(int statusCode, String body) {
        super("place search " + statusCode + ": " + truncate(body, 200));
